// 导入 用layui upload插件layui.use([ "element", "laypage", "layer", "upload"],
// function() {
layui.use(['layer', 'tree', 'table', 'form'], function() {
	var layer = layui.layer, table = layui.table, tree = layui.tree, dataList = [], form = layui.form;
